...
temperature = bs.find_all("span",  class_ ="CurrentConditions--tempValue--3a50n")
conditions = bs.find_all("div", class_ = "CurrentConditions--phraseValue--2Z18W")
city_name = bs.find_all("h1", class_ = "CurrentConditions--location--kyTeL")
